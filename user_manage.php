	...
	<div id="add">
		<form action="user_manage.php#add" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td>User ID: <input type="text" name="a_userid" size="30" required></td>
				</tr>
				<tr>
					<td>Name: <input type="text" name="a_username" size="30" required></td>
				</tr>
				<tr>
					<td>Password: <input type="text" name="a_userpass" size="30" required></td>
				</tr>
				<tr>
					<td>Email: <input type="email" name="a_useremail" size="30" required></td>
				</tr>
				<tr>
					<td>User Type:
			...
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td>User ID:
						...
						&nbsp;&nbsp;<input type="submit" name="refreshuser" value="Refresh">
					</td>
				</tr>
				<tr>
					<td>New User Name: <input type="text" name="e_username" size="30"></td>
				</tr>
				<tr>
					<td>New User Email: <input type="text" name="e_useremail" size="30"></td>
				</tr>
				<tr>
					<td><input type="submit" name="edituser" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
