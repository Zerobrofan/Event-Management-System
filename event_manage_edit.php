			...
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td>Event:
						...
						&nbsp;&nbsp;<input type="reset" name="refreshevent" value="Refresh">
					</td>
				</tr>
				<tr>
					<td>New Event Name: <input type="text" name="e_eventname" size="35" required></td>
				</tr>
				<tr>
	...
	<div id="editdate">
		<form action="event_manage_edit.php#editdate" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td colspan="2"><input type="submit" name="editdate" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
	...
	<div id="edittime">
		<form action="event_manage_edit.php#edittime" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td colspan="2"><input type="submit" name="edittime" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
	...
	<div id="editcategory">
		<form action="event_manage_edit.php#editcategory" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td>New Event Category: <br><textarea name="e_eventcategory" rows="2" cols="50" placeholder="eg: Concert, Sports, Talk, Festival etc..." required></textarea></td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" name="editcategory" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
	...
	<div id="editdescription">
		<form action="event_manage_edit.php#editdescription" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td>New Event Description: <br><textarea name="e_eventdescription" rows="5" cols="60" style="text-align: justify" required></textarea></td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" name="editdescription" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
	...
	<div id="editvenue">
		<form action="event_manage_edit.php#editvenue" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td colspan="2"><input type="submit" name="editvenue" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
	...
	<div id="editticketprice">
		<form action="event_manage_edit.php#editticketprice" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td>New Ticket Price (EGP):<input type="number" name="e_eventticketprice" min="00" placeholder="0" required></td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" name="editticketprice" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
	...
	<div id="edittickettotal">
		<form action="event_manage_edit.php#edittickettotal" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr>
					<td>New Number of Ticket: <input type="number" name="e_eventtickettotal" min="10" placeholder="10" required></td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" name="edittickettotal" value="Save">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" name="cancel" value="Cancel">
					</td>
				</tr>
			</table>
